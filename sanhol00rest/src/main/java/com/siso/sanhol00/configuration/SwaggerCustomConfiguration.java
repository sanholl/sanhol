package com.siso.sanhol00.configuration;
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)//문서화 유형 설정
							...
							.build()
								.apiInfo(//문서의 대표정보
									new ApiInfoBuilder()
													.title("기능 구현 테스트") // 문서의 제목
													.description("기능 구현하기 전 간단한 테스트") // 문서의 설명
													.version("0.0.1")
													.license("MIT License") // 라이센스 정보 - MIT License는 무료배포라는 의미라서 만약 라이브러리중 라이센스를 의무적으로 지켜야한다면 사용할 수 없다.
												.build()
									)
